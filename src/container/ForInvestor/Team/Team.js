  ...
  return (
    <main className="team w-100 h-100">
      <Container className="team_wrap  d-flex flex-column justify-content-center align-items-center">
        ...
        <CardDeck>
          <Card className="shadow team_card">
            <Card.Img
              variant="top"
              src={team1}
            ...
            <Card.Body className="d-flex flex-column align-items-center text-center">
              ...
              <Card.Text className="team_card-text">
                He is a seasoned developer. Lorem Ipsum is simply dummy text of
          ...
          <Card className="shadow team_card">
            ...
            <Card.Body className="d-flex flex-column align-items-center text-center">
              ...
              <Card.Text className="team_card-text">
                ...
                grow too big to manage, he decided to centralize his experience
                with the advent of today’s technology.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card className="shadow team_card">
